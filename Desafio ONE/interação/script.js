...
function descriptografar(){
    ...
    document.getElementById.innerHTML = '</textarea readonly id="input-texto">' + resultDescripto + '<textarea>' + '<button class="btn-copiar" id="copiar" onclick="copiar()">Copiar</button>'
}
